...
window.I18N = {
  zh: {
    ...
    gpa: {
      title: "G.P.A. 计算器",
      hint: "按学年（或学期）录入课程、学分、成绩与课程级别，GPA 即时计算。成绩可按字母等级或百分制输入，评分标准可自行修改。数据只保存在您自己的浏览器中，不会上传。",
      startStep1: "第一步：确认评分标准",
      startStep1Hint: "默认为常见的美国高中标准（A 从 93 分起，荣誉 +0.5，AP / IB +1.0）。如学校采用不同标准，请先点“编辑”。",
      startStep2: "第二步：选择起点",
      startTitle: "从哪里开始？",
      startPreset: "标准四年课表",
      startPresetDesc: "美国大学预备的常见四年课程序列，9–12 年级各 6–8 门。课程名称、学分、级别都可以改。",
      startBlank: "空白开始",
      startBlankDesc: "自己逐门添加课程。",
      gradeN: "{n} 年级",
      ...
      gradeNone: "—",
      gradePass: "P",
      gradePlaceholder: "A- 或 91",
      addCourse: "添加课程",
      addPeriod: "添加学年 / 学期",
      removePeriod: "删除该学年",
      removePeriodConfirm: "删除该学年及其中的 {n} 门课程？",
      periodNamePlaceholder: "学年或学期名称",
      cumulative: "累计 GPA",
      ...
      totalCredits: "总学分",
      totalPeriods: "总课时",
      inProgress: "另有 {w} {unit}进行中，未计入。",
      prior: "已有成绩（可选）",
      priorGpa: "GPA",
      priorCredits: "学分",
      print: "打印 / PDF",
      clear: "清空",
      clearConfirm: "清空所有课程与成绩？评分标准和设置会保留。",
      planTitle: "目标规划",
      planTarget: "目标 GPA",
      planRemain: "剩余{unit}",
      planOut: "剩余课程需平均绩点 {p}（不加权）",
      planOver: "剩余课程需平均绩点 {p}，超出评分标准最高值 {max}，不加权下无法达到。",
      planDone: "目标已达到。",
      scaleTitle: "评分标准",
      scaleGrade: "等级",
      scaleMin: "起始分",
      ...
      scaleHonors: "荣誉",
      scaleAP: "AP / IB",
      scaleNote: "P = 通过，计学分不计绩点。",
      scaleEdit: "编辑",
      scaleEditTitle: "编辑评分标准",
      scaleEditHint: "起始分为该等级的最低百分制分数；CP / 荣誉 / AP 为各级别课程的绩点。修改后所有课程绩点即时重算。",
      scaleAdd: "添加等级",
      scaleReset: "恢复默认",
      done: "完成",
      settingGrade: "成绩输入",
      ...
      unitCredits: "学分",
      unitPeriods: "课时",
      footnote: "仅供家庭规划参考，不构成正式成绩单。",
      printTitle: "GPA 计算（非正式）",
      printedOn: "打印日期",
    },
  },
  en: {
    ...
    gpa: {
      ...
      hint: "Enter each course with its credits, grade and level by school year (or semester); the GPA updates as you type. Grades can be letters or percentages, and the grading scale is editable. Everything stays in your own browser — nothing is uploaded.",
      startStep1: "Step 1: confirm the grading scale",
      startStep1Hint: "The default is the common US high-school scale (A from 93, Honors +0.5, AP / IB +1.0). If your school uses different cutoffs, edit it first.",
      startStep2: "Step 2: choose a starting point",
      startTitle: "Where would you like to start?",
      startPreset: "Standard four-year plan",
      startPresetDesc: "The common US college-prep sequence, 6–8 courses a year for grades 9–12. Names, credits and levels are all editable.",
      startBlank: "Start blank",
      startBlankDesc: "Add courses one by one.",
      gradeN: "Grade {n}",
      ...
      gradeNone: "—",
      gradePass: "P",
      gradePlaceholder: "A- or 91",
      addCourse: "Add course",
      addPeriod: "Add year / semester",
      removePeriod: "Remove this year",
      removePeriodConfirm: "Remove this year and its {n} courses?",
      periodNamePlaceholder: "Year or semester name",
      ...
      inProgress: "{w} more {unit} in progress, not counted.",
      prior: "Prior record (optional)",
      priorGpa: "GPA",
      priorCredits: "Credits",
      print: "Print / PDF",
      clear: "Clear",
      clearConfirm: "Clear every course and grade? The grading scale and settings are kept.",
      planTitle: "Target planning",
      planTarget: "Target GPA",
      planRemain: "Remaining {unit}",
      planOut: "Remaining courses need an average of {p} (unweighted)",
      planOver: "Remaining courses would need an average of {p}, above the scale maximum of {max} — not reachable unweighted.",
      planDone: "Target already reached.",
      ...
      scaleHonors: "Honors",
      scaleAP: "AP / IB",
      scaleNote: "P = pass: earns credit, no grade points.",
      scaleEdit: "Edit",
      scaleEditTitle: "Edit grading scale",
      scaleEditHint: "From = the lowest percentage for that letter; CP / Honors / AP are the grade points for each course level. Every course recalculates as you edit.",
      scaleAdd: "Add grade",
      scaleReset: "Restore defaults",
      done: "Done",
      settingGrade: "Grade entry",
      settingLetter: "Letters",
      settingPercent: "Percent",
      settingUnit: "Weight unit",
      settingCredits: "Credits",
      settingPeriods: "Periods / week",
      unitCredits: "credits",
      unitPeriods: "periods",
      footnote: "For family planning only — not an official transcript.",
      printTitle: "GPA calculation (unofficial)",
      printedOn: "Printed",
    },
  },
};
...
window.GPA_PRESET = [
  { grade: 9, rows: [
    ["English 9", "英语 9", 1, true],
    ["Algebra I", "代数 I", 1, true],
    ["Biology", "生物", 1, true],
    ["World History / Geography", "世界历史 / 地理", 1, true],
    ["Foreign Language I", "外语 I", 1, true],
    ["Bible", "圣经", 1, false],
    ["PE / Health", "体育 / 健康", 0.5, false],
    ["Fine Arts", "艺术", 0.5, false],
  ] },
  { grade: 10, rows: [
    ["English 10", "英语 10", 1, true],
    ["Geometry", "几何", 1, true],
    ["Chemistry", "化学", 1, true],
    ["World History II", "世界历史 II", 1, true],
    ["Foreign Language II", "外语 II", 1, true],
    ["Bible", "圣经", 1, false],
    ["PE", "体育", 0.5, false],
    ["Fine Arts", "艺术", 0.5, false],
  ] },
  { grade: 11, rows: [
    ["English 11 (American Literature)", "英语 11（美国文学）", 1, true],
    ["Algebra II", "代数 II", 1, true],
    ["Physics", "物理", 1, true],
    ["U.S. History", "美国历史", 1, true],
    ["Foreign Language III", "外语 III", 1, true],
    ["Bible", "圣经", 1, false],
    ["Elective", "选修", 0.5, false],
  ] },
  { grade: 12, rows: [
    ["English 12 (British Literature)", "英语 12（英国文学）", 1, true],
    ["Pre-Calculus", "预备微积分", 1, true],
    ["Science Elective (Anatomy / Environmental)", "科学选修（解剖 / 环境）", 1, true],
    ["Government & Economics", "政府与经济", 1, true],
    ["Foreign Language IV", "外语 IV", 1, true],
    ["Bible", "圣经", 1, false],
    ["Elective", "选修", 0.5, false],
  ] },
];

// Common US high-school course names offered as typing suggestions on the
// course field (a datalist — anything typed is still accepted). The live
// catalog's high-school course names are appended at run time.
window.GPA_COMMON_COURSES = [
  ["English 9", "英语 9"], ["English 10", "英语 10"], ["English 11", "英语 11"], ["English 12", "英语 12"],
  ["Composition", "写作"], ["Speech / Public Speaking", "公众演讲"], ["Literature", "文学"],
  ["Pre-Algebra", "预备代数"], ["Algebra I", "代数 I"], ["Geometry", "几何"], ["Algebra II", "代数 II"],
  ["Pre-Calculus", "预备微积分"], ["Calculus", "微积分"], ["Statistics", "统计"],
  ["Physical Science", "物理科学"], ["Biology", "生物"], ["Chemistry", "化学"], ["Physics", "物理"],
  ["Anatomy & Physiology", "解剖与生理"], ["Environmental Science", "环境科学"],
  ["World History", "世界历史"], ["World Geography", "世界地理"], ["U.S. History", "美国历史"],
  ["Government", "政府"], ["Economics", "经济"], ["Psychology", "心理学"],
  ["Spanish I", "西班牙语 I"], ["Spanish II", "西班牙语 II"], ["Latin I", "拉丁语 I"], ["Latin II", "拉丁语 II"],
  ["French I", "法语 I"], ["Japanese I", "日语 I"], ["Chinese", "中文"],
  ["Bible", "圣经"], ["Theology", "神学"], ["Church History", "教会史"], ["Apologetics", "护教学"], ["Logic", "逻辑"], ["Rhetoric", "修辞"],
  ["PE", "体育"], ["Health", "健康"], ["Music", "音乐"], ["Art", "艺术"], ["Computer Science", "计算机科学"],
];
