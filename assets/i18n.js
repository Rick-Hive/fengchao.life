...
window.I18N = {
  zh: {
    ...
    gpa: {
      ...
      startStep2HintAgain: "已有一张课表，可以继续填写。",
      continueSheet: "继续填写当前课表",
      continueSheetMeta: "{p} 个学期 · {n} 门课程",
      restartHead: "或重新开始（将替换当前课表）",
      scope: "仅供高中课程",
      ...
      startReplaceConfirm: "当前课表已填有成绩。重新选择起点会替换整张课表，继续？",
      confirmOk: "确定",
      confirmCancel: "取消",
      scaleTitle: "评分标准",
      scaleGrade: "等级",
  ...
  en: {
    ...
    gpa: {
      ...
      startStep2HintAgain: "You already have a sheet — carry on with it.",
      continueSheet: "Continue the current sheet",
      continueSheetMeta: "{p} semesters · {n} courses",
      restartHead: "Or start over (replaces the current sheet)",
      ...
      startReplaceConfirm: "The current sheet has grades in it. Starting again replaces the whole sheet — continue?",
      confirmOk: "OK",
