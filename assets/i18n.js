...
window.I18N = {
  zh: {
    ...
    gpa: {
      ...
      totalCredits: "总学分",
      totalPeriods: "每周总课时",
      inProgress: "其中 {w} {unit}尚无成绩，未计入 GPA。",
      prior: "此前成绩（如转学，可选）",
      priorGpa: "GPA",
      priorCredits: "学分",
      print: "打印 / PDF",
      ...
      studentLabel: "学生姓名（打印用，可选）",
      schoolLabel: "学校或机构名称（打印用，可选）",
      printSchool: "学校 / 机构",
      printTitle: "G.P.A. 成绩计算表",
      printUnofficial: "非正式文件 · 仅供家庭规划参考",
      printStudent: "学生",
      printedOn: "打印日期",
      printSource: "本表由家长在 fengchao.life 的 G.P.A. 计算器中自行录入生成，不构成正式成绩单。",
    },
  },
  en: {
    ...
    gpa: {
      ...
      startAppendNote: "You already have a sheet: a choice here is added after it — nothing is cleared.",
      ...
      totalCredits: "Total credits",
      totalPeriods: "Total periods / week",
      inProgress: "{w} {unit} of it not yet graded, not in the GPA.",
      prior: "Prior record (e.g. transfer, optional)",
      priorGpa: "GPA",
      ...
      studentLabel: "Student name (for printing, optional)",
      schoolLabel: "School or institution (for printing, optional)",
      printSchool: "School / institution",
      printTitle: "G.P.A. Calculation Sheet",
      printUnofficial: "Unofficial · for family planning only",
      printStudent: "Student",
      printedOn: "Printed",
      printSource: "Prepared by the family in the G.P.A. calculator at fengchao.life. Not an official transcript.",
    },
  },
};
