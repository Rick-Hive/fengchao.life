...
window.I18N = {
  zh: {
    ...
    gpa: {
      ...
      startReplaceNote: "当前已有课表：选择后将替换全部课程与成绩（评分标准和设置保留）。",
      startReplaceConfirm: "替换当前课表？所有课程与成绩将被清除。",
      ...
      startPreset: "标准四年课表",
      startPresetDesc: "美国大学预备的常见四年课程序列，9–12 年级各 6–8 门，按上下学期各计半学分。",
      startBlank: "空白开始",
      ...
      splitTerms: "分学期",
      mergeTerms: "合并学期",
      mergeTermsConfirm: "合并上下学期？两学期的课程将并入一张表。",
  ...
  en: {
    ...
    gpa: {
      ...
      startReplaceNote: "You already have a sheet: choosing here replaces every course and grade (the scale and settings are kept).",
      startReplaceConfirm: "Replace the current sheet? Every course and grade will be cleared.",
      ...
      startPresetDesc: "The common US college-prep sequence, 6–8 courses a year for grades 9–12, half a credit per semester.",
      startBlank: "Start blank",
      startBlankDesc: "Add courses one by one.",
      gradeN: "Grade {n}",
      termFall: "Fall",
      termSpring: "Spring",
      splitTerms: "Split into semesters",
      mergeTerms: "Merge semesters",
      mergeTermsConfirm: "Merge the two semesters into one table?",
