...
window.I18N = {
  ...
  en: {
    ...
    step0Hint: "Choose your child's learning stage. Stage names follow the pedagogy you chose; each card shows the grades it covers.",
    stageNeedPedagogy: "Choose a pedagogy first.",
    step1Title: "Choose a graduation track",
    step1Hint: "Only {stage} requires a graduation track. Choose one of the three tracks; click a card to read about it.",
    modes: {
      international: { name: "International Track", desc: "An international track taught mainly in English, aimed at applying to overseas universities." },
      domestic: { name: "Domestic Track", desc: "A domestic track taught mainly in Chinese." },
      hybrid: { name: "Hybrid 2+2 Track", desc: "A 2+2 track combining high school with community-college dual-enrollment credits." },
    },
    step2Title: "Step 1: Choose your pedagogy",
    step2Hint: "Choose the educational approach you use for your child. This choice decides what the stages are called and which courses they include.",
    pedagogies: {
    ...
    step3Hint: "Below are the graduation credit requirements for the selected track. Please read them carefully, then click Next.",
    reqSubject: "Subject",
    ...
    mapHint: "Grades run across and subjects run down: each cell shows the courses and materials planned for that subject in that grade. A green mark means Hive currently offers a course there; click any cell to see everything in it.",
    mapMore: "+{n}",
    mapAvail: "{n} available",
    mapPlanned: "Planned courses and materials",
    mapCourses: "Available Hive courses",
    mapNoCourses: "No courses are available for this subject and grade yet. Coming soon.",
    ...
    searchPh: "Type a keyword, e.g. Chinese, math, biology…",
    resultCount: "courses",
    cardName: "Course",
    cardCode: "Course ID",
    cardAbout: "About",
    ...
    cartDropped: "{n} of these courses are no longer offered and were removed automatically.",
    dCode: "Course ID",
    dSubject: "Subject",
    dGrades: "Grades",
    dLanguage: "Language",
    ...
    dCreditHours: "Credits",
    dSchedule: "Schedule",
    dTeachers: "Teacher(s)",
    dPrice: "Price",
    dSchool: "Course provider",
    ...
    step5Title: "Confirm and submit your order",
    step5Hint: "Check your selected courses, enter your contact details, then submit. After you submit, we will contact you by email; payment and enrollment are arranged separately with the local hive that offers each course.",
    orderSummary: "Order summary",
    remove: "Remove",
    emailLabel: "Contact email (required)",
    emailPh: "example@gmail.com",
    emailNote: "Please use an international email service such as Gmail, Outlook or Yahoo. QQ, 163, Sina and similar email services are not supported at this time.",
    teamsLabel: "EquipMe Teams account (optional)",
    teamsPh: "Your Teams account",
    submitOrder: "Submit order",
    submitting: "Submitting…",
    doneTitle: "Order submitted!",
    doneDesc: "We have received your course order and will contact you by email shortly. Please keep your order number:",
    doneAgain: "Confirm",
    stepNeedEarlier: "Complete the earlier steps first",
    stepNeedCart: "Choose at least one course first",
    errEmail: "Please enter a valid email address.",
    errEmailDomain: "QQ, 163, Sina and similar email services are not supported at this time. Please use an international email service such as Gmail, Outlook or Yahoo.",
    ...
    gpa: {
      ...
      hint: "Enter grades as letters or percentages; you can edit the grading scale; non-academic courses are not counted in the GPA; you can print your data, and nothing is uploaded or saved online.",
      ...
      startStep1Hint: "The default is the common US high-school scale (A from 93, Honors +0.5, AP / Dual Enrollment +1.0). If your school uses a different scale, click Edit first. When it is correct, go on to the next step.",
      ...
      scaleNote: "P = Pass: earns credit but no grade points; non-academic courses also earn credit only.",
      scaleEdit: "Edit",
...
window.LEARNING_STAGES = [
  {
    ...
    classical: {
      ...
      descEn: "Kindergarten through Grade 6: the Grammar stage focuses on memorization and fundamentals — Chinese language arts, early science, English foundations and more. Browse the catalog directly.",
    },
    standard: {
      zh: "小学", en: "Elementary",
      descZh: "幼儿园至六年级：中文母语课、科学启蒙、英语基础等，直接浏览选课。",
      descEn: "Kindergarten through Grade 6: Chinese language arts, early science, English foundations and more — browse the catalog directly.",
    },
  },
  {
    key: "dialectic",
    ...
    classical: {
      ...
      descEn: "Grades 7–8: training in logical reasoning and argument — browse the catalog directly.",
    },
    standard: {
      zh: "初中", en: "Middle School",
      descZh: "七至八年级：初中各科课程，直接浏览选课。",
      descEn: "Grades 7–8: middle-school courses in every subject — browse the catalog directly.",
    },
  },
  {
    key: "rhetoric",
...
window.SITE_MENUS = [
  ...
  // anything administrative stays out of this repo.
  {
    ...
    items: [
      ...
      // 问答(Q&A) left the menu on 2026-09-24 (Rick); it stays one tab away
      // on every help page.
    ],
  },
];
