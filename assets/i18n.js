...
window.I18N = {
  zh: {
    ...
    gpa: {
      title: "G.P.A. 计算器",
      hint: "按学期录入课程、学分、成绩与课程级别，GPA 即时计算；每个学期单独显示 GPA，并汇总为累计 GPA。成绩可按字母等级或百分制输入，评分标准可自行修改。数据只保存在您自己的浏览器中，不会上传。",
      ...
      periodNamePlaceholder: "学期名称，如 2026 秋",
      cumulative: "累计 GPA",
  ...
  en: {
    ...
    gpa: {
      ...
      hint: "Enter each course with its credits, grade and level by semester; every semester shows its own GPA and they roll up into the cumulative GPA. Grades can be letters or percentages, and the grading scale is editable. Everything stays in your own browser — nothing is uploaded.",
      ...
      periodNamePlaceholder: "Semester name, e.g. Fall 2026",
